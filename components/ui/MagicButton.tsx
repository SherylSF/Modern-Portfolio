...
const MagicButton = ({
  ...
  return (
    <div>
        <button className="relative inline-flex h-12 w-full overflow-hidden rounded-lg p-[1px] focus:outline-none sm:w-30 sm:mt-8 md:w-60 md:mt-7 lg:w-60 lg:mt-10" onClick={handleClick}>
